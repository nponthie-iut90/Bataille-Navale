    ...
    */
    ...
    /*
        ...
        void testShipHorizontalVariant1Player1() {
            ...
            boolean result = stageModel.isShipWillBeInBoardAndLegal(1, 0, 0, true, 1, 1);
            assertTrue(result);
        }
        ...
        void testShipVerticalVariant1Player1() {
            ...
            boolean result = stageModel.isShipWillBeInBoardAndLegal(1, 0, 0, false, 1, 1);
            assertTrue(result);
        }
        ...
        void testShipOutOfBounds() {
            ...
            when(shipMock.getSize()).thenReturn(3);
            player1Board.addShipToBoard(shipMock, 0, 0, true);
            boolean result = stageModel.isShipWillBeInBoardAndLegal(1, 9, 9, true, 1, 1);
            assertFalse(result);
        }
    ...
    void testIsInValideCells_ValidPlacement() {
        ...
        when(stageModel.isInValideCells(anyInt(), anyInt(), anyInt(), any(int[][].class), anyBoolean(), anyInt(), anyInt())).thenReturn(false);
        boolean result = stageModel.isInValideCells(gameVariant, player, shipNumber, shipFutureCoordinates, horizontal, colindex, rowindex);
        assertFalse(result);
    }
    ...
    void testIsInValideCells_InvalidPlacement() {
        ...
        int gameVariant = 1;
        when(stageModel.calcValideCells(player)).thenReturn(new int[10][10]);
        when(stageModel.isInValideCells(anyInt(), anyInt(), anyInt(), any(int[][].class), anyBoolean(), anyInt(), anyInt())).thenReturn(true);
    ...
    void testAddShipAfterCheck_GameVariant1_Player1() {
        ...
        stageModel.addShipAfterCheck(0, 1, 0, true, 1, 1);
    ...
    void testAddShipAfterCheck_GameVariant1_Player2() {
        ...
        stageModel.addShipAfterCheck(0, 2, 0, true, 1, 2);
    ...
    void testAddShipAfterCheck_GameVariant2_Player1() {
        ...
        stageModel.addShipAfterCheck(0, 1, 0, true, 2, 1);
        verify(player1Board).addShipToBoard(ship, 0, 0, true);
    }
    ...
    void testAddShipAfterCheck_GameVariant2_Player2() {
        ...
        stageModel.addShipAfterCheck(0, 2, 0, true, 2, 2);
        verify(player2Board).addShipToBoard(ship, 0, 0, true);
    }
     */
    ...
    void testAttackPlayer1Hit() {
        ...
        String result = stageModel.attack(player, attackMarkIndex, rowIndex, colIndex);
